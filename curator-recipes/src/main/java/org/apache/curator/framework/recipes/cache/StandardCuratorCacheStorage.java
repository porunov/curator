...
class StandardCuratorCacheStorage implements CuratorCacheStorage
{
    ...
    @Override
    public Optional<ChildData> compute(String path, BiFunction<String, ? super ChildData, ? extends ChildData> remappingFunction)
    {
        return Optional.ofNullable(dataMap.compute(path, remappingFunction));
    }
